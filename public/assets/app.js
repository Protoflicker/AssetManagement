...
(function () {
  ...
  async function renderProfile() {
    ...
    if (IS_ADMIN) {
      ...
      var waStatus = el('div', { style: 'font-size:0.72rem;color:var(--text-muted);margin-top:4px;margin-bottom:12px' });
      ...
      var waSave = el('button', { class: 'sesd-btn sesd-btn-primary', html: ic('check') + ' Simpan Nomor' });
      ...
      wa.appendChild(waStatus); wa.appendChild(waSave);
      grid.appendChild(wa);
    }
