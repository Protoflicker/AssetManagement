-- ============================================================
--  migrate-v5 — data resets requested for the individual-item model.
--  Run ONCE in the Neon SQL editor (or: npm run db:run db/migrate-v5.sql).
--  These are destructive; review before running.
-- ============================================================

-- #11 — Hard reset room placement. Every asset is currently pinned to
...
-- #12 — Restore asset codes to match daftaraset2025.xlsx. The importer split
